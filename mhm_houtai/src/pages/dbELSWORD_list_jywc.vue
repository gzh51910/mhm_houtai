<template>
    ...
    <el-table-column prop="address" label="time" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="address" label="price" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="address" label="count" show-overflow-tooltip>
    </el-table-column>
    <el-table-column prop="address" label="all_price" show-overflow-tooltip>
    </el-table-column>
